...
import com.ra.hotel.entity.Room;
...
public class RoomDAO implements GenericDao<Room> {
    ...
    @Override
    public Room save(final Room room) throws DaoException {
    ...
    @Override
    public Room update(final Room room) throws DaoException {
        try (Connection connection = dataSource.getConnection();
    ...
    @Override
    public long delete(final long id) throws DaoException {
        try (Connection connection = dataSource.getConnection();
    ...
    @Override
    public Room findById(final long id) throws DaoException {
        try (Connection connection = dataSource.getConnection();
    ...
    private PreparedStatement getStatement(final PreparedStatement prepare, final Room room) throws SQLException {
        ...
        prepare.setLong(2, room.getType().getId());
