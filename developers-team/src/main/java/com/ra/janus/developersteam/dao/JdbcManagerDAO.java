...
public class JdbcManagerDAO implements BaseDao<Manager> {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(JdbcManagerDAO.class);
    public static final String EXCEPTION_WARN = "An exception occurred!";

    transient private final DataSource dataSource;

    public JdbcManagerDAO(final DataSource dataSource) {
